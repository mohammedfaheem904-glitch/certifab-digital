          ...
          >
            {({ values, set }) => (
              <div className="grid grid-cols-2 gap-3">
                ...
                <F label="Process">
                  <Input required value={values.process ?? ""} onChange={(e) => set("process", e.target.value)} placeholder="GTAW" />
                </F>
                ...
                <F label="Position">
                  <Input value={values.position_qualified ?? ""} onChange={(e) => set("position_qualified", e.target.value)} placeholder="6G" />
                </F>
                <F label="Test Coupon">

...
function Dashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Lists */}
      <div className="grid lg:grid-cols-3 gap-4">
        <Card className="lg:col-span-2" title="Recent welds" right={<Link to="/app/welds" search={{ workflow: undefined }} className="text-xs text-primary hover:underline">View all</Link>}>
      ...
      <div className="grid lg:grid-cols-3 gap-4">
        <Card className="lg:col-span-2" title="Workflow bottlenecks" right={<Link to="/app/welds" search={{ workflow: undefined }} className="text-xs text-primary hover:underline">All welds</Link>}>
          <WorkflowBottlenecks />
        </Card>
